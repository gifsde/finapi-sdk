...
class NewTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Transaction type, according to the bank. If set, this will contain a German term that you can display to the user. Some examples of common values are: \"Lastschrift\", \"Auslands&uuml;berweisung\", \"Geb&uuml;hren\", \"Zinsen\".
     *
     * @return self
     */
