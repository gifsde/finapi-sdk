...
class MoneyTransferOrderParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $counterpart_bic BIC of the counterpart's account. Only required for SEPA payments (i.e. payments in EUR currency), when there is no 'IBAN_ONLY'-capability in the respective account/interface combination that is to be used when submitting the payment.
     *
     * @return self
     */
